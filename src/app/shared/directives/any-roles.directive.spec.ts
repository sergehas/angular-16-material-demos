...
describe('AnyRolesDirective', () => {
  ...
  beforeEach(() => {
    ...
    mockLoginService.getLoggedUser.and.returnValue(SignedUser.from(
      'John', 'Doe', '123', true, ['ADMIN', 'AUTHOR']));
    ...
    directives = fixture.debugElement.queryAll(By.directive(AnyRolesDirective)).map(de => de.injector.get(AnyRolesDirective));
