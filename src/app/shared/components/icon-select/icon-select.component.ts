import {
	Component, ElementRef, EventEmitter, Input, OnDestroy, OnInit, Output, forwardRef, Self, Optional, ViewChild, ViewEncapsulation,
} from "@angular/core";
...
@Component({
	...
	providers: [{ provide: MatFormFieldControl, useExisting: forwardRef(() => IconSelectComponent) }],
})
export class IconSelectComponent extends AbstractMatFormField<string>
