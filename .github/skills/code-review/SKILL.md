...
Only show things that you think are bad and important to change.

## Important :

If a change is good just don't mention it, we are only reviewing errors or mistakes.
...
- Respect DRY, KISS, SOLID principles
